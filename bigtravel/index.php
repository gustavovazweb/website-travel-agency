...
<html lang="pt-br">
<head>
	<title>Bigtravel - Agência de Viagens</title>
<!--META TAGS-->
	<meta charset="utf-8">
	<meta name="viewport" content="width=device-width,initial-scale=1.0">
	<meta name="author" content="Gustavo Vaz">
	<meta name="descryption" content="Agência de Viagens e Turismo pelo Mundo">
	<meta name="keywords" content="turismo,viagens,pacotes,hoteis,passagens aéreas">
...
<!--SIDENAV-->
	<header>
		<ul class="sidenav" id="menu-mobile">
					...
					<li><a href="#sobre" class="sidenav-close white-text">Sobre a Bigtravel</a></li>
					<li><a href="#pacotes" class="sidenav-close white-text">Pacotes</a></li>
					<li><a href="#unidades" class="sidenav-close white-text">Unidades</a></li>	
					<li><a href="#contato" class="sidenav-close white-text">Contato</a></li>
				</ul>
<!--MENU PRINCIPAL-->
		...
		<nav class="navbar z-depth-0">
			<div class="nav-wrapper container">
				...
				<a href="index.html"><img src="img/logo.png" alt="Bigtravel - Agência de Viagens" class="logo-img"></a>
				<ul class="menu right hide-on-med-and-down">
					<li><a href="#home">Home</a></li>
					<li><a href="#sobre">Sobre a Bigtravel</a></li>
	...
	<section class="home bloco scrollspy" id="home"> 
		<div class="banner row container">
			<div class="col s12 center">
				<h2 class="white-text">Venha viajar com a gente!</h2>
				<p class="white-text light">Temos as melhores opções para você fazer sua viagem com conforto, segurança e muita diversão. Conheça nossos pacotes nacionais e internacionais, deixe a Bigtravel tornar a sua viagem uma experiência inesquecível para sua vida.</p>
				<a href="#sobre" class="btn btn-sobre btn-large cor-primaria cor-secundaria">Sobre nós</a>
				<a href="#contato" class="btn btn-contato btn-large black-text">Contato</a>
			</div>
		</div>		
	</section>
<!--ABOUT SECTION-->
...
<!--SECTION-->
		<div class="mvv row cor-primaria">
			<div class="container">
...
<!--PACKAGES-->
	<section class="pacotes bloco scrollspy" id="pacotes">
		<div class="row container">
			<div class="col s12 center">
				<h2 class="titulo-padrao white-text light">Pacotes</h2>
				<p class="white-text light texto-padrao">Possuímos uma gama enorme de pacotes de viagem para todos os destinos do planeta, nacional ou internacional, não importa, a Bigtravel estará presente em todo o mundo para te atender com qualidade e eficiência. Confira nossos pacotes!</p>
			</div>
		</div>
		<div class="row container">
			...
			<article class="col s12 m6 l3">
				<div class="card">
					<div class="card-image">
						...
						<a href="#modal-americadonorte" class="btn btn-floating halfway-fab cor-primaria cor-secundaria modal-trigger"><i class="material-icons">more_horiz</i></a>
					</div>
...
<!--NORTH AMERICA - MODAL-->	
			<div class="modal" id="modal-americadonorte">
				...
				<div class="modal-footer">
					<a class="btn cor-primaria cor-secundaria modal-action modal-close">Sair</a>
				</div>
			</div>
<!--EUROPE - CONTENT-->
			<article class="col s12 m6 l3">
				<div class="card">
					<div class="card-image">
						...
						<a href="#modal-europa" class="btn btn-floating halfway-fab cor-primaria cor-secundaria modal-trigger"><i class="material-icons">more_horiz</i></a>
					</div>
					<div class="card-content">
						<h5>Europa</h5>
			...
			<article class="col s12 m6 l3">
				<div class="card">
					<div class="card-image">
						...
						<a href="#modal-africa" class="btn btn-floating halfway-fab cor-primaria cor-secundaria modal-trigger"><i class="material-icons">more_horiz</i></a>
					</div>
					<div class="card-content">
						<h5>África</h5>
			...
			<article class="col s12 m6 l3">
				<div class="card">
					<div class="card-image">
						...
						<a href="#modal-asia" class="btn btn-floating halfway-fab cor-primaria cor-secundaria modal-trigger"><i class="material-icons">more_horiz</i></a>
					</div>
					<div class="card-content">
						<h5>Ásia</h5>
...
<!--SCHEDULE-->		
		<div class="row center">
			 <a href="#tabela-horarios" class="btn btn-large cor-primaria cor-secundaria modal-trigger btn-horarios"><i class="material-icons left">timer</i>Tabela de Horários</a>
		</div>
...
<!--FRANCHISES-->
	<section class="unidades bloco scrollspy" id="unidades">
		<div class="row container">
			<div class="col s12 center">
				<h2 class="titulo-padrao white-text">Unidades</h2>
				<p class="texto-padrao white-text">Confira todas as nossas unidades. Estamos presentes nas maiores e mais importantes capitais da região sudeste e também da região sul, faça-nos uma visita!</p>
			</div>
		</div>
		<div class="row container">
<!--FRANCHISE - SÃO PAULO-->
...
<!--CONTACT-->
	<section class="contato bloco scrollspy" id="contato">
		<div class="row container">
			<div class="col s12 center">
				<h2 class="titulo-padrao">Contato</h2>				
			</div>		
<!--CONTACT - MAPA-->
		<div class="col s12 m6 l4 hide-on-med-only">
			<div class="mapa transparent">
				<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d117033.75522094198!2d-46.680400390488145!3d-23.557492303155115!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x7ce3064d4452d59!2sUsytur%20Ag%C3%AAncia%20de%20Viagens%20e%20Turismo!5e0!3m2!1spt-BR!2sbr!4v1571769186642!5m2!1spt-BR!2sbr" width="600" height="450" frameborder="0" style="border:0;" allowfullscreen=""></iframe>
			</div>
		</div>
<!--CONTACT - REDES SOCIAIS-->		
		<div class="col s12 m6 l4">
			<div class="redes-sociais">
				...
				<p class="texto-padrao white-text">Siga-nos em nossas redes sociais e fique por dentro das nossas promoções.</p>
				<div class="contato-botoes">
					<a href="#" class="btn btn-floating cor-primaria cor-secundaria"><i class="fa fa-facebook"></i></a>
					<a href="#" class="btn btn-floating cor-primaria cor-secundaria"><i class="fa fa-twitter"></i></a>
					<a href="#" class="btn btn-floating cor-primaria cor-secundaria"><i class="fa fa-google"></i></a>
				</div>
				<h5 class="white-text">Endereço</h5>
				<p class="texto-padrao white-text">Rua das Árvores nº 252, centro São Paulo-SP</p>
				<h5 class="white-text">Contatos</h5>
				<p class="texto-padrao white-text">
					<i class="material-icons left">phone</i>(11) 321-8585<br>
...
<!--CONTACT - FALE CONOSCO-->	
		<div class="col s12 m6 l4">
			<div class="fale-conosco">
				...
				<p class="texto-padrao">Dúvidas, críticas e sugestões!? Entre em contato conosco, seu feedback é muito importante.</p>
				<form method="post" action="mail.php">
					...
					<button class="btn cor-primaria cor-secundaria" type="submit">Enviar</button>					
				</form>
			</div>
		</div>
		</div>
...
<!--OPNIONS-->
	<div class="depoimentos cor-primaria">
		<div class="row container">
			<div class="col s12 center">
				<h2 class="titulo-padrao white-text">Depoimentos</h2>
			</div>
<!--OPNIONS - NUMBER 1-->
			<div class="col s12 m4 center">
				<img src="img/depoimento1.jpg" class="circle responsive-image">
...
<!--OPNIONS - NUMBER 2-->
			<div class="col s12 m4 center">
				<img src="img/depoimento2.jpg" class="circle responsive-image">
...
<!--OPNIONS - NUMBER 3-->
			<div class="col s12 m4 center">
				<img src="img/depoimento3.jpg" class="circle responsive-image">
	...
	<footer class="rodape">
		<div class="row container">
			<div class="col s12 center">
				...
				<p>© Bigtravel Agência de Viagens e Turismo 2020 - Todos os direitos reservados</p>
			</div>
		</div>		
	</footer>
